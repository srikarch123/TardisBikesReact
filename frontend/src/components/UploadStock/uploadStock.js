...
class UploadProductPage extends React.Component {
        ...
        switch(id){
            ...
            case 'origin':
                ...
                if(value.length>0){
                    ...
                    errors.origin="Enter Country Origin"
                }
                break;
            default:
                break;            
    ...
    submitData = e=>{
        ...
        if(visited.image && visited.title && visited.quantity && visited.totalStock && visited.category && visited.price && visited.description && visited.units && visited.origin){
            if(errors.image.length===0 && errors.category.length===0 && errors.title.length===0 && errors.quantity.length===0 && errors.totalStock.length===0 && errors.price.length===0 && errors.description.length===0 && errors.units.length===0 && errors.origin.length === 0){
