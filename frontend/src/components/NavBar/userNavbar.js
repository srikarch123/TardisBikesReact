                ...
                <nav className="navbar bg-danger shadow rounded">
                    <div className="container text-white">
                        ...
                        <ul class="nav justify-content-end col-lg-6 mx-auto my-auto">
                            <li class="nav-item">
                                <a className="btn btn-danger" href="/user-home" >Home</a>
                            </li>
                            <li class="nav-item">
                                <a className="btn btn-danger" href="/shopping-cart" >Cart</a>
                            </li>
                            <li class="nav-item">
                                <a className="btn btn-danger" href="/your-orders" >Your Orders</a>
                            </li>
                            <li class="nav-item">
